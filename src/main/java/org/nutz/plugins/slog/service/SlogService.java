...
public class SlogService {
	 ...
	 * @param e      异常对象
	 */
	public void log(String t, String tag, String source, CharSegment seg, Map<String, El> els, boolean async,
			Object[] args, Object re, Method method, Object obj, Throwable e) {
		String _msg = null;
		if (seg.hasKey()) {
