...
public class MenuController {
	...
	@POST
	@Ok("json")
	public boolean checkMenuUnique(@Param("id") String id, @Param("parentId") String parentId,
	...
	public Object editDo(@Param("..") Menu menu, @Param("parentId") String parentId, Errors es,
